...
def vdw(pc, tc, x, volumen, esp):
    ...
    print('\nParámetros generales a & b de la ecuación de Van der Waals')
...
def fug_bin(TC, PC, ESP, T):
    ...
    for i in range(len(X1)):
        ...
        for j in range(len(P)):
            ...
            cf, f = fugacidad(P[j], T, v, X, b, A, B)
            CF_sub1.append(cf[0])
            CF_sub2.append(cf[1])
